...
myApp.controller('setupAppController', ['$scope','setupInitService', function($scope, setupInitService) {
    ...
    $scope.openLightboxModal = function (index) {
        Lightbox.openModal($scope.layouts, index);
    };
...
myApp.directive('ngLightbox', ['$compile', function($compile) {
...
myApp.directive('ngLightboxClose', function() {
    return function(scope, element, attr) {
